...
#include "../../../../Projects/Past Paper App/selection.h"
...
static constexpr auto qt_meta_stringdata_ZN9SelectionE = QtMocHelpers::stringData(
    "Selection",
...
Q_CONSTINIT static const uint qt_meta_data_ZN9SelectionE[] = {
...
Q_CONSTINIT const QMetaObject Selection::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9SelectionE.offsetsAndSizes,
    qt_meta_data_ZN9SelectionE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9SelectionE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Selection, std::true_type>,
        // method 'Admin_Button_Is_Clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'User_Button_Is_Clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void Selection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Selection::*)();
            if (_q_method_type _q_method = &Selection::Admin_Button_Is_Clicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (Selection::*)();
            if (_q_method_type _q_method = &Selection::User_Button_Is_Clicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *Selection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9SelectionE.stringdata0))
